...
const SuccessToast: React.FC<ToastProps> = ({ toastId, heading, message }) => {
  return (
    <div className="bg-success-50 border border-success p-2 rounded-xs flex items-start w-full gap-3 font-roboto">
      <div className="p-1 bg-success-600 rounded ">
        <SuccessIcon size={16} color="#ffffff" />
      </div>
