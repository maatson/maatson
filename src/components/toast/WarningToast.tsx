...
const WarningToast: React.FC<ToastProps> = ({ toastId, heading, message }) => {
  return (
    <div className="bg-warning-50 border border-warning p-2 rounded flex items-start w-full gap-3 font-roboto">
      <div className="p-1 bg-warning rounded ">
        <WarningIcon size={16} color="white" />
      </div>
      <div className="flex flex-col gap-1 text-sm w-full">
        <p className="text-warning font-semibold capitalize">{heading}</p>
