...
const columns: any[] = [
  {
    id: "containerNumber",
    label: "BL / Booking / Container Number",
    minWidth: 140,
  },
...
const VendorForShippingList: React.FC = () => {
    ...
    <>
      <div className="flex justify-between p-3 border-b border-b-grey-ab-50 items-center">
        ...
        <div className="flex items-center gap-4">
          <Link to={"/other-vendors/vendor-for-shipping/create"}>
            <PrimaryButton
...
export default VendorForShippingList;
