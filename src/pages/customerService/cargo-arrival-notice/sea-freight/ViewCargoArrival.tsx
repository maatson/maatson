    ...
    const createData = (items: any) => {
      ...
      const actions = (
        <div className="px-2 py-1 gap-2 flex justify-center ">
          <NavLink
            to={`/cargo-arrival-notice/sea-freight/details/${id}/${canNumber}`}
          >
          ...
          <NavLink
            to={`/cargo-arrival-notice/sea-freight/edit/${id}/${canNumber}`}
          >
      ...
      {data.length === 0 ? (
        <div className="flex flex-col rounded-xs bg-grey-aw-50 shadow-lg">
          <div className="p-3 border-b border-b-grey-ab-50 flex justify-between items-center">
            ...
            <NavLink to={`/cargo-arrival-notice/sea-freight/create/${id}`}>
              <PrimaryButton
                label={"Create CAN"}
                size={"m"}
                variant={"primary"}
