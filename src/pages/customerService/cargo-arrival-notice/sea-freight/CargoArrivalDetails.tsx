    ...
    <div className="flex flex-col gap-6 bg-grey-aw-50 py-4 rounded-xs shadow-lg">
      <div className="flex justify-between py-1 px-4 items-center">
        ...
        <div className="flex gap-4 ">
          <NavLink to={`/cargo-arrival-notice/sea-freight/edit/${id}/${canNo}`}>
            <NeutralBlueButton
              label={"Edit"}
              size={"m"}
              variant={"primary"}
      ...
      <div className="flex flex-col ">
        ...
        <div className="flex flex-col gap-4 px-6 py-4">
          <div className="flex flex-col">
            <div className="flex bg-grey-ab-50 border-y border-y-grey-ab-100 gap-2 text-sm font-bold px-2">
              <div className="p-3 w-[30%]">Container Types</div>
              <div className="p-3">Container Number</div>
            </div>
            {data.containerDetails.map((container, index) => (
              <div
                className="flex border-b border-b-grey-ab-100 gap-2 text-sm px-2"
                key={index}
              >
                <div className="p-3 w-[30%]">{container.containerType}</div>
                <div className="p-3 flex gap-3">
                  {container.containerNumbers.map((item, i) => (
