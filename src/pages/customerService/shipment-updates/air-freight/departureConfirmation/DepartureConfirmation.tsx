...
interface RowData {
  ...
  departureConfirmationStatus: boolean | React.ReactNode;
  mailStatus: boolean | React.ReactNode;
  departureDate: string | React.ReactNode;
...
const columns: any[] = [
  ...
  {
    id: "departureConfirmationStatus",
    label: "Departure Confirmation Status",
    align: "center",
    minWidth: "220px",
  },
...
const DepartureConfirmation: React.FC = () => {
  ...
  const createData = (items: any) => {
    ...
    const actions = (
      <div className="px-2 py-1 gap-2 flex justify-center items-center font-semibold">
        ...
        <Link
          ...
          to={`/shipment-updates/air-freight/departure-confirmation/view/${bookingId}`}
        >
    ...
    let departureConfirmationStatusText: string | React.ReactNode = "-"; // Default status
    if (departureConfirmationStatus) {
      departureConfirmationStatusText = (
    ...
    const updatedData = {
      ...
      departureConfirmationStatus: departureConfirmationStatusText || "-",
  ...
  const data = [
    {
      ...
      departureConfirmationStatus: true,
      mailStatus: true,
    ...
    },
    {
      ...
      bookingValidityDate: "2025-02-01",
      departureConfirmationStatus: false,
      mailStatus: false,
      departureDate: "2025-02-01",
    },
    {
