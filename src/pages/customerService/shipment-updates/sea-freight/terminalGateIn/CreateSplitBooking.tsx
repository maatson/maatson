...
const CreateSplitBooking: React.FC = () => {
  ...
  const [data, setData] = useState<BookingProps>({
    ...
    portOfDischarge: "",
    products: [],
    cargoDetails: { cargoType: "fcl", cargoDimensions: [{}] },
    goodsDateInformation: {
      date: new Date(),
  ...
  return (
    <>
      <div className="bg-grey-aw-50 px-8 py-4 rounded flex flex-col gap-8">
        <p className="text-lg font-semibold"> Split Booking(1109092)</p>
        ...
        <div className="flex justify-end gap-6">
          ...
          <div onClick={handleSubmit}>
            <PrimaryButton
              label={"Convert into Split Booking"}
              size={"xl"}
              variant={""}
            />
          </div>
