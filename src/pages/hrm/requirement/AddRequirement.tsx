...
const AddRequirement: React.FC<AddRequirementsProps> = ({ cancel }) => {
  return (
    <>
      ...
      <div className=" fixed inset-x-72 inset-y-16 z-40 mx-auto top-10 rounded-md flex bg-[white]  custom-scroll p-8 gap-8 flex-col overflow-auto custom-scrollbar">
        ...
        <div className="flex items-center gap-6 justify-end">
          ...
          <PrimaryButton label={"Post Requirement"} size={"xl"} variant={""} />
        </div>
      </div>
    </>
  );
