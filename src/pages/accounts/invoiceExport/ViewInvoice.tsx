        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center text-sm">
            <div className="flex items-center gap-2 bg-grey-50 px-2 py-3 rounded-sm font-semibold ">
              <button>
                <NavLink
                  to={`/accounts/invoice-export/view-invoice/${id}/proforma`}
                  className={({ isActive }) =>
                    `${
              ...
              <button>
                <NavLink
                  to={`/accounts/invoice-export/view-invoice/${id}/collection`}
                  className={({ isActive }) =>
                    `${
                      isActive ? "bg-primary-900 text-grey-aw-50" : ""
                    } px-4 py-2 rounded transition-all duration-500`
              ...
              <button>
                <NavLink
                  to={`/accounts/invoice-export/view-invoice/${id}/taxInvoice`}
                  className={({ isActive }) =>
                    `${
                      isActive ? "bg-primary-900 text-grey-aw-50" : ""
                    } px-4 py-2 rounded transition-all duration-500`
