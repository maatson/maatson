...
import EditAgentDebitPaySlip from "../../components/dashboard/EditAgentDebitPaySlip";
import ViewAgentDebitPaySlip from "../../components/dashboard/ViewAgentDebitPaySlip";

interface RowData {
  id: string | number;
  debitSlipNumber: string;
...
interface InitialDataProps {
  ...
  remittanceRef: string;
  paidDate: string;
  debitNoteInvoiceNumbers: string[];
  agentName: string;
  agentAdress: string;
  phoneNumber: string;
  bankName: string;
...
const columns: any[] = [
  { id: "debitSlipNumber", label: "Debit Slip Number", minWidth: 160 },
...
const ViewDebitSlips: React.FC = () => {
  ...
  const createData = (items: any) => {
    ...
    const updatedData = {
      id: id,
      debitSlipNumber: items?.debitSlipNumber,
  ...
  const data = [
    {
      debitSlipNumber: "DB10132001",
      remittanceRef: "ref20250001",
      paidDate: "23-03-2025",
      debitNoteInvoiceNumbers: [
        "DB10132001",
        "DB10132002",
        "DB10132003",
        "DB10132004",
