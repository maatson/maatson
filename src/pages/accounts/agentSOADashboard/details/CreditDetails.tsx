...
const CreditDetails: React.FC = () => {
  const { id, creditInvoiceId } = useParams();
  ...
  const [data, setData] = useState({
    ...
    creditInvoiceNumber: "CR20250001",
    ...
    <>
      <div className="bg-grey-aw-50 flex flex-col gap-6 px-8 py-6 rounde-xs shadow-lg">
        <div className="flex justify-end gap-4">
          <NavLink
            to={`/accounts/agent-soa-dashboard/credit-detail-edit/${id}/${creditInvoiceId}`}
          >
            <NeutralBlueButton
              label={"Edit"}
              size={"m"}
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col gap-3">
            <AccountsModel
              ...
              value={data.creditInvoiceNumber}
              parentStyle="gap-2"
            />
            <AccountsModel
              label={"Credit Invoice Date "}
              value={"11-06-2025"}
              parentStyle="gap-2"
            />
          </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <AccountsModel
            label={"Agent Credit Reference Numberc"}
