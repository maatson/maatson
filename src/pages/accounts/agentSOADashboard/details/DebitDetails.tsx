...
const DebitDetails: React.FC = () => {
  const { id, debitInvoiceId } = useParams();
    ...
    <>
      <div className="bg-grey-aw-50 flex flex-col gap-6 px-8 py-6 rounde-xs shadow-lg">
        <div className="flex justify-end gap-4">
          <NavLink
            to={`/accounts/agent-soa-dashboard/debit-detail-edit/${id}/${debitInvoiceId}`}
          >
            <NeutralBlueButton
              label={"Edit"}
              size={"m"}
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col gap-3">
            <AccountsModel
              label={"Debit Invoice Number "}
              value={data.debitInvoiceNumber}
              parentStyle="gap-2"
            />
            <AccountsModel
              label={"Debit Invoice Date "}
              value={"11-06-2025"}
              parentStyle="gap-2"
            />
          </div>
          ...
          <div className="flex justify-between">
            ...
            <div className="flex flex-col gap-2 p-3 ">
              ...
              <AccountsModel
                label={"SGST  9%"}
                value={
                  data.agentGSTIN.slice(0, 2) === data.gstin.slice(0, 2)
              ...
              <div className="flex gap-1 items-center">
                <p className="font-bold text-grey-ab-800 w-[180px]">
                  TOTAL DUE
                </p>
