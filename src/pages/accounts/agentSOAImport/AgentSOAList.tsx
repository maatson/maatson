...
interface RowData {
  ...
  customerName: string;
  creditNote: string | React.ReactNode;
  debitNote: string | React.ReactNode;
  action: React.ReactNode;
}

const columns: any[] = [
  { id: "bookingID", label: "Booking ID", minWidth: 140 },
...
const AgentSOAList: React.FC = () => {
  ...
  const createData = (items: any) => {
    ...
    const actions = (
      <>
        <Link to={`/accounts/agent-soa-import/view/${id}`}>
          <PrimaryButton
            label={"View"}
            size={"s"}
            variant={"primary"}
    ...
    const updatedData = {
      ...
      creditNote: <div className="font-bold">{items?.creditNote}</div>,
      debitNote: <div className="font-bold">{items?.debitNote}</div>,
  ...
  const data = [
    {
      ...
      customerName: "Farrel Kurniawan",
      carrierdebitNote: "Pending",
      creditNote: "100 USD",
      debitNote: "100 USD",
    },
    {
      ...
      customerName: "Dimas Kamal",
      carrierdebitNote: "Completed",
      creditNote: "100 USD",
      debitNote: "100 USD",
    },
    {
