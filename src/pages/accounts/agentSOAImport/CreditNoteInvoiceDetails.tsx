  ...
  return (
    <div className="bg-grey-aw-50 flex flex-col gap-6 px-8 py-6 rounde-xs shadow-lg">
      <div className="flex justify-end gap-4">
        <NavLink to={`/accounts/agent-soa-import/credit-edit/${id}/${creditId}`}>
          <NeutralBlueButton
            label={"Edit"}
            size={"m"}
            variant={"primary"}
      ...
      <div className="flex flex-col gap-4">
        <div className="grid gap-4 grid-cols-5">
          ...
          <AccountsModel
            ...
            parentStyle="flex-col"
          />
          <AccountsModel label={"LINE NO"} value={data.lineNumber} parentStyle="flex-col" />
          <AccountsModel
            label={"IGM NO"}
...
export default CreditNoteInvoiceDetails;
