...
interface ViewAgentDebitPaySlipProps {
  onClose: () => void;
  onEdit: () => void;
  initialData: InitialDataProps;
}

const ViewAgentDebitPaySlip: React.FC<ViewAgentDebitPaySlipProps> = ({
  onClose,
  onEdit,
  initialData,
}) => {
  ...
  return (
    <div className="flex flex-col gap-6 px-8 py-6 bg-grey-aw-50 rounded-xs shadow-lg max-w-[800px] max-h-[600px] overflow-auto custom-scrollbar">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex flex-col gap-2">
          <AccountsModel
            label={"Debit Slip Number:"}
            value={data.debitSlipNumber}
            parentStyle="py-1 gap-2"
          />
          <AccountsModel
            label={"Debit Slip Date:"}
            value={data.paidDate}
            parentStyle="py-1 gap-2"
          />
        </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-3 flex-wrap py-1">
          {data.debitNoteInvoiceNumbers.map((item) => (
      ...
      <div className="flex flex-col">
        ...
        />
        <AccountsModel
          label={"Agent SOA Debit Amount"}
          value={data.agentSOADebitAmount.toLocaleString("en-IN")}
...
export default ViewAgentDebitPaySlip;
