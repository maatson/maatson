...
const ConvertToBooking: React.FC = () => {
  ...
  return (
    <div className="bg-grey-aw-50 px-8 py-4 rounded flex flex-col gap-8">
      <p className="text-lg font-semibold"> Convert to Booking</p>
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          {/* <GroupField
            ...
            parentStyle="w-2/5"
          /> */}
          <p className="font-semibold">Assigned Person Name</p>
          <p>Adithya Arunachalam</p>
        </div>
        <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-6">
          {" "}
          <HeadTitle label={"Goods Ready Date"} icon={<RangeCalenderIcon />} />
