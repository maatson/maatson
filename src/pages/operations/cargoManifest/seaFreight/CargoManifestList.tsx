...
interface RowData {
  ...
  cargoManifestStatus: boolean | React.ReactNode;
  cargoManifestDate: string | React.ReactNode;
...
const columns: any[] = [
  ...
  {
    id: "cargoManifestStatus",
    label: "Cargo Manifest Status",
    align: "center",
    minWidth: "160px",
  },
  { id: "cargoManifestDate", label: "Cargo Manifest Date" },
  {
    id: "action",
    label: "Action",
    align: "center",
...
const CargoManifestList: React.FC = () => {
  ...
  const createData = (items: any) => {
        ...
        {cargoManifestStatus ? (
          <div className="flex items-center gap-2">
            <Link
              ...
              to={`/cargo-manifest/sea-freight/edit/${bookingId}`}
            >
              <EditIcon color="#fdfdfd" size={16} />
            </Link>
            <Link
              className="p-1 rounded bg-black"
              to={`/cargo-manifest/sea-freight/view/${bookingId}`}
            >
              <EyeOpenIcon color="#fdfdfd" size={16} />
            </Link>
          </div>
        ) : (
          <Link to={`/cargo-manifest/sea-freight/create/${bookingId}`}>
            <PrimaryButton
              label={"Create"}
              size={"s"}
              variant={""}
    ...
    let cargoManifestStatusText: string | React.ReactNode = "-"; // Default status
    if (cargoManifestStatus) {
      cargoManifestStatusText = (
    ...
    const updatedData = {
      ...
      cargoManifestDate: cargoManifestDate || "-",
      cargoManifestStatus: cargoManifestStatusText || "-",
  ...
  const data = [
    {
      ...
      cargoManifestStatus: true,
      mailStatus: true,
      cargoManifestDate: "2025-02-01",
    },
    {
      bookingId: "Emp0021",
      companyName: "maatson",
...
export default CargoManifestList;
